...
To start container back up, type:
docker start backend

IF you choose to not use a Docker container, you need to install dependencies in requirements.txt and then run python hi.py

I didn't make a Dockerfile for frontend aha.

To install dependencies for frontend, go into frontend directory and run:
npm install

To run frontend locally, type:
npm run dev
